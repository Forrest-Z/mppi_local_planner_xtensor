#ifndef MPPI_LOCAL_PLANNER_TOOLS_DISTANCE_CALCULATIONS_H
#define MPPI_LOCAL_PLANNER_TOOLS_DISTANCE_CALCULATIONS_H

#include <Eigen/Core>
#include <mppi_local_planner/tools/misc.h>
...
#endif /* MPPI_LOCAL_PLANNER_TOOLS_DISTANCE_CALCULATIONS_H */
