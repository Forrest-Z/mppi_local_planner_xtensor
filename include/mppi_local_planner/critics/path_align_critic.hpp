#ifndef MPPI_LOCAL_PLANNER_CRITICS_PATH_ALIGN_CRITIC_HPP
#define MPPI_LOCAL_PLANNER_CRITICS_PATH_ALIGN_CRITIC_HPP
...
#endif // MPPI_LOCAL_PLANNER_CRITICS_PATH_ALIGN_CRITIC_HPP
